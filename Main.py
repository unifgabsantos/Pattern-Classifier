...
Classificador = MLPClassifier(hidden_layer_sizes = ([200]*8), alpha=1, max_iter=1000000)
...
ClassificadorPCA = MLPClassifier(hidden_layer_sizes = ([100]*5), alpha=1, max_iter=10000)
